  ...
  return (
    <SafeAreaView className="flex-1 bg-hi-bg" edges={['top']}>
      ...
      <View className="flex-row items-center px-6 py-4 bg-white border-b border-hi-gray-10">
        ...
        <Text className="text-xl font-black text-hi-dark tracking-tight">Saved Memories</Text>
      </View>
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 12 }}>
        {loading ? (
          ...
          <View className="mt-40 items-center justify-center">
             ...
             <Text className="text-lg font-bold text-hi-dark mb-2">Nothing saved yet</Text>
             <Text className="text-sm text-hi-gray-30 text-center px-10">Save travel stories from the Intel Hub to keep them in your private collection.</Text>
          </View>
        ) : (
